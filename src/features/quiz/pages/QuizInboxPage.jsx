...
export default function QuizInboxPage() {
  ...
  return (
    <div className="dd-container" style={{ paddingBlock: '4rem' }}>
      <div className="dd-container dd-container--narrow" style={{ textAlign: 'center' }}>
        <div className="dd-card" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 64, height: 64, marginBottom: 24 }}>
        ...
        <p style={{ marginTop: 24, fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>
